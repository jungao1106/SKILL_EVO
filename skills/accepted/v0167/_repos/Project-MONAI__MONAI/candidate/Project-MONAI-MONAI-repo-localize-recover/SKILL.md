...
5 task events; 3 positive events; paths=monai/transforms/spatial/array.py, monai/transforms/utility/dictionary.py, monai/data/utils.py, monai/transforms/utility/array.py, monai, monai/transforms; tests=none; failures=localization-drift
