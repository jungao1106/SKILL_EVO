---
name: celery-kombu-repo-recover
description: Test-time repo skill distilled from evaluator-approved benchmark evidence for celery__kombu.
active: true
quality_score: 0.71
quality_tier: repo
risk_flags: []
...
- Support: `2`
- Support repos: celery__kombu

## Trigger

current task is in repo celery__kombu; failure signature matches repeated repo failures
...
2 task events; 0 positive events; paths=none; tests=none; failures=localization-drift
