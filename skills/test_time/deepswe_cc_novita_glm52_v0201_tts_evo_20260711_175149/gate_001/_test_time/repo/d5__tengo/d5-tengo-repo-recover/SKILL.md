---
name: d5-tengo-repo-recover
description: Test-time repo skill distilled from evaluator-approved benchmark evidence for d5__tengo.
active: true
quality_score: 0.71
quality_tier: repo
risk_flags: []
...
- Support: `2`
- Support repos: d5__tengo

## Trigger

current task is in repo d5__tengo; failure signature matches repeated repo failures
...
2 task events; 0 positive events; paths=none; tests=none; failures=weak-validation
