---
name: mattn-anko-repo-recover
description: Test-time repo skill distilled from evaluator-approved benchmark evidence for mattn__anko.
active: true
quality_score: 0.71
quality_tier: repo
risk_flags: []
...
- Support: `2`
- Support repos: mattn__anko

## Trigger

current task is in repo mattn__anko; failure signature matches repeated repo failures
...
2 task events; 0 positive events; paths=none; tests=none; failures=localization-drift, weak-validation
